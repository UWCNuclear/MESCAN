...
#		step:					The value by which the DME and TME must change after every Gosia run
...
try:
	...
	raise SystemExit('Usage: autoGos.py <Inputfile>')
	print(arg[::-1])
...
while(diagME <= DME_high and transME <= (TME_high + step)):
